...
function Header() {
    ...
    const logOutMutation = useMutation({
        mutationKey: ['logout'],
        mutationFn: () => RegisterAndLoginApi("logout", {}),
        onSuccess: () => {
            dispatchData({ type: "removeUser" })
            queryClient.clear()
                    ...
                    <div className="h-right d-flex align-items-center order-1">
                        ...
                        <Dropdown className="dropdown user-profile ms-2 ms-sm-3 d-flex align-items-center">
                            <div className="u-info me-2">
                                <p className="mb-0 text-end line-height-sm "><span className="font-weight-bold">{(user.firstname + " " + user.lastname) || "Dylan Hunter"}</span></p>
                                <small>{"Admin Profile"}</small>
                            </div>
                            <Dropdown.Toggle as="a" className="nav-link dropdown-toggle pulse p-0">
                                <div className="avatar lg rounded-circle img-thumbnail" src={ProfileImg} alt="profile" >
                                    <UserIconsIndex />
                                </div>
                                ...
                                <div className="card border-0 w280">
                                    <div className="card-body pb-0">
                                        <div className="d-flex py-1">
                                            <div className="avatar rounded-circle" src={ProfileImg} alt="profile" >
                                                <UserIconsIndex />
                                            </div>
                                            {/* <img className="avatar rounded-circle" src={ProfileImg} alt="profile" /> */}
                                            <div className="flex-fill ms-3">
                                                <p className="mb-0"><span className="font-weight-bold">{user.firstname || "Dylan Hunter"}</span></p>
                                                <small className="">{user.email || "Dylan.hunter@gmail.com"}</small>
                                            </div>
                                        </div>
                                    ...
                                    <div className="list-group m-2 ">
                                        ...
                                        <Button to="sign-in" className="list-group-item list-group-item-action border-0 "
                                            onClick={() => logOutMutation.mutate()}
                                        ><i className="icofont-logout fs-6 me-3"></i>Signout</Button>
                                        <div><hr className="dropdown-divider border-dark" /></div>
