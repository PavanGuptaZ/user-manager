...
import UserProfile from "./manager/UserProfile";
    ...
    return (
        <div className="main px-lg-4 px-md-4">
            ...
            <div className="body d-flex py-lg-3 py-md-2">
                <Switch>
                    <Route exact path={`${process.env.PUBLIC_URL}/`} index component={HrDashboard} />
                    ...
                    <Route exact path={`${process.env.PUBLIC_URL}/roles`} component={Roles} />
                    <Route exact path={`${process.env.PUBLIC_URL}/users`} component={Users} />
                    <Route exact path={`${process.env.PUBLIC_URL}/user/:id`} component={UserProfile} />
                </Switch>
            </div>
        </div>
    )
